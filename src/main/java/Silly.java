...
public class Silly implements Comparable<Silly>{
     ...
     * @param string1 The fist string taken as this Silly instance's name
     * @param string2 The second string taken as this Silly instance's name
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int slength = other.name.length();
        if (this.name.length() > slength){
            return 1;}
        else if (this.name.length() == slength){
            return 0;}
        else {
            return -1;
        }
